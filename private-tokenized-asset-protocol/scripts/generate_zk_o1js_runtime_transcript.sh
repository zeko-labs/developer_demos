...
OUT_FILE="${OUT_DIR}/zk-o1js-runtime-demo-${STAMP}.md"
...
{
  echo "# TAP Real o1js Runtime Demo Transcript"
  echo
  ...
  echo "- Eligibility proof is generated as \`zk-o1js-proof\`."
  echo "- External verifier validates the proof in \`o1js-runtime\` mode."
...
capture "Run Real o1js Runtime Flow" "${ROOT_DIR}/scripts/run_zk_o1js_runtime_demo.sh"
