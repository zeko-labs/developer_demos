...
SUBJECT_COMMITMENT="${SUBJECT_COMMITMENT:-subj_customer_kyc_001}"
AUTH_PROFILE_NAME="${AUTH_PROFILE_NAME:-customerKycBearer}"
KYC_URL="${KYC_URL:-https://sandbox.api.customer.example/v1/customers/cust_demo_001/kyc-status}"

echo "[1/2] Collecting customer KYC attestation through generic-rest..."
