...
- Main trading UI: `public/darkpool.html`
- Landing and access flow: `public/index.html`
- Partner example UI: `public/partner-frontend.html`
- Runtime and route wiring: `src/darkpool-server.js`

Prefer this skill before changing:
- order entry state and collateral messaging
- activity timeline, chart, or order book layout
- wallet / funding UX
- first-visit onboarding or dense trading panel composition
