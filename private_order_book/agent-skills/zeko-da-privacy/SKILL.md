...
- App-side DA publishing hooks: `src/darkpool-server.js`
- Deployment knobs and topology: `docs/deployment.md`
- Architecture context: `docs/architecture.md`

Prefer this skill before changing DA publication format, encryption defaults, or privacy language around what is and is not hidden.
